    ...
    if ($foto_baru) {
        if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
            ...
            if (!in_array($fileExtension, $allowedExtensions)) {
                ...
                window.location.href = '../edit/informasi.php';
                </script>";
            } else {
                if ($_FILES['foto']['size'] > 5242880) {
                    ...
                    $sql = "UPDATE informasi SET judul = '$judul', deskripsi = '$deskripsi', 
        ...
        $sql = "UPDATE informasi SET judul = '$judul', deskripsi = '$deskripsi' WHERE id = '$id'";
