...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM tendik WHERE id = '$id'");
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="../controllerEdit/tendik.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?= $data['id']?>">
                ...
                <div class="mb-3">
                    ...
                    <img src="../fotoStaff/<?= $data['foto'] ?>" class="mb-2" style="height: 70px" alt="no">
