...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM visi WHERE id = '$id'");
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="../controllerEdit/visi.php" method="POST">
                <div class="mb-3" style="display: none;">
                    <input type="text" value="<?= $data['id'] ?>" name="id">
                </div>
                <div class="mb-3">
                    <label for="visi" class="form-label">Visi</label>
                    <input type="text" class="form-control" value="<?= $data['visi'] ?>" name="visi" id="visi">
                </div>
